...
EPS::standard_reply EPS::switch_PDU_to_safety_mode(DWire &wire, uint8_t i2c_address) {
    standard_reply reply;
...
EPS::standard_reply EPS::switch_PIU_to_safety_mode(DWire &wire, uint8_t i2c_address) {
    standard_reply reply;
